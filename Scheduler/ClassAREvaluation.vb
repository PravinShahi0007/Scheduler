Public Class ClassAREvaluation
    ...
    Function querylistNoticeInvoice(ByVal typ As String, ByVal cond As String, ByVal id_mail_manage_par As String) As String
        ...
        If typ = "1" Then
            ...
            q_having = ""
            q_order_by = "sp.id_sales_pos ASC "
        ElseIf typ = "2" Then
        ...
        Try
            ...
            If data_cek_eval.Rows(0)("jum_eval") > 0 Then
                ...
                Dim querylog As String = "INSERT INTO tb_ar_eval_log(eval_date, log_time, log, is_success) 
                    VALUES('" + date_eval + "', NOW(), 'Email Hold Delivery Sent successfully',1); " + mm.queryInsertLog("0", "2", "Sent successfully") + "; "
                execute_non_query(querylog, True, "", "", "", "")
            End If
        Catch ex As Exception
            'Log
            Dim query_log As String = "INSERT INTO tb_ar_eval_log(eval_date, log_time, log, is_success) 
            VALUES('" + date_eval + "', NOW(), 'Failed send email Hold Delivery : " + addSlashes(ex.ToString) + "',2); " + mm.queryInsertLog("0", "3", addSlashes(ex.ToString))
            execute_non_query(query_log, True, "", "", "", "")
        End Try
    ...
    Sub sendEmailPeringatan(ByVal date_eval As String, ByVal id_group As String, ByVal id_store_comp As String, ByVal group_name As String)
        ...
        Try
            ...
            If data_cek_eval.Rows(0)("jum_eval") > 0 Then
                ...
                mm.mail_subject = mail_subject
                mm.createEmail(id_group, "0", "NULL", "NULL", "")
                id_mail = mm.id_mail_manage
                ...
                'log
                Dim querylog As String = "INSERT INTO tb_ar_eval_log(eval_date, log_time, log, is_success) 
                    VALUES('" + date_eval + "', NOW(), '" + group_name + " - Email Sent successfully',1); " + mm.queryInsertLog("0", "2", "" + group_name + " - Sent successfully") + "; "
                execute_non_query(querylog, True, "", "", "", "")
