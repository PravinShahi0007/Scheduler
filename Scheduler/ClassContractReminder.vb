Public Class ClassContractReminder
    Public Shared Sub contract_reminder()
        Dim query As String = "
            SELECT emp.id_employee, emp.employee_name, emp.employee_position, dep.departement, emp.employee_join_date, emp.start_period, emp.end_period, lvl.grup_penilaian, emp_head.id_employee AS id_employee_head, emp_head.employee_name AS employee_name_head, emp_head.email_external AS email_external_head
    ...
    Sub send_email(data As DataTable, i As Integer)
        ...
        mail.Body = "
            ...
            <br>
            <p style='font: normal 10.00pt/14.25pt Arial; margin: 0;'>" + data.Rows(i)("employee_name").ToString + " berakhir " + Date.Parse(data.Rows(i)("end_period").ToString).ToString("dd MMMM yyyy") + ".</p>
            <br>
        ...
        If data.Rows(i)("grup_penilaian").ToString = "1" Then
            ...
            mail.Attachments.Add(New Net.Mail.Attachment(path_temp))
        Else
            'asst. spv - sr. manager
